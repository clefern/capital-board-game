// ========================================
// BonusCalculator - Cálculo de Bônus (Shared)
// ========================================

import { BRAND_BONUS, REGION_BONUS_PER_BUSINESS, NEIGHBORHOOD_BONUS, REGION_RENT_TIER, RENT_TIER_MULTIPLIER } from './constants.js';
import { SPACES, getAdjacentSpaces } from './board-layout.js';
